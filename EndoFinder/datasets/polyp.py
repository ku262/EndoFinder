...
from EndoFinder.datasets.image_folder import get_image_paths
from EndoFinder.datasets.isc.descriptor_matching import (
    knn_match_and_make_predictions,
    match_and_make_predictions,
)
from EndoFinder.datasets.isc.io import read_ground_truth
from EndoFinder.datasets.isc.metrics import evaluate, Metrics


class POLYPEvalDataset:
    """POLYP evaluation dataset."""
    ...
    def retrieval_eval_splits(
        ...
        **kwargs
        ...
        query_names = ["Q%04d" % i for i in query_ids]
        ref_names = ["R%04d" % i for i in ref_ids]
